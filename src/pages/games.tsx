  ...
  return (
    <>
      <div className="flex flex-col w-full min-h-screen bg-[#1A1C26]">
        ...
        <div className="flex flex-col items-center mt-4 xl:ml-52 xl:mr-20 2xl:ml-48 w-[350px] sm:w-[500px] md:w-[640px] lg:w-[800px] xl:w-[1100px] 2xl:min-w-[1300px] flex-grow">
          {/* Ordenação */}
          ...
          <div className="flex flex-col w-full bg-[#272932] ">
            <div className="py-6 px-4 xl:px-7">
              <div className="grid grid-cols-3 gap-x-3 gap-y-3 sm:grid-cols-3 sm:gap-x-4 sm:gap-y-3 md:grid-cols-3 md:gap-x-6 md:gap-y-4 lg:grid-cols-6 lg:gap-y-4 xl:gap-y-4 xl:grid-cols-6 2xl:grid-cols-6">
