      ...
      text-lg font-bold"
       ...
       will-change-[opacity,transform] data-[side=top]:animate-slideDownAndFade"
        ...
        <div className="">
          <button
            type="submit"
            className="flex items-center justify-center rounded-2xl bg-gradient-to-t from-[#4D23A5] to-[#783FCF] brightness-105 hover:from-[#5D23A5] hover:to-[#813FCF] h-10 w-16 text-sm font-medium text-white group-disabled:pointer-events-none"
